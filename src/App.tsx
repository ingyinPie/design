        ...
        <header className="mb-8 animate-fade-in">
          ...
          <div className="text-center">
            <div className="flex items-center justify-center gap-3 mb-2">
              <div className="w-12 h-12 bg-gradient-to-br from-[#196E7F] to-[#145664] rounded-[16px] flex items-center justify-center shadow-md">
              ...
              <>
                {generatedContent ? (
                  ...
                  <div className="card-float text-center py-16 animate-fade-in">
                    <div className="w-20 h-20 bg-gradient-to-br from-[#196E7F] to-[#145664] rounded-[20px] flex items-center justify-center mx-auto mb-4">
