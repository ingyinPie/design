        ...
        <header className="mb-8 animate-fade-in">
            ...
            <div className="flex items-center justify-start gap-1">
              <button
                ...
                className={`btn-secondary flex items-center gap-2 ${
                  !showScheduleView
                    ? '!bg-[#5ABA8A] !text-white rounded-lg'
                    : ''
                }`}
              >
              ...
              >
                <CalendarDays className="w-4 h-4" style={{ color: showScheduleView ? 'white' : '#E1F196' }} />
          ...
          <div className="text-center">
            <div className="flex items-center justify-center gap-3 mb-2">
              <div className="w-12 h-12 bg-gradient-to-br from-[#5ABA8A] to-[#4AA87A] rounded-[16px] flex items-center justify-center shadow-md">
              ...
              <>
                {generatedContent ? (
                  ...
                  <div className="card-float text-center py-16 animate-fade-in">
                    <div className="w-20 h-20 bg-gradient-to-br from-[#5ABA8A] to-[#4AA87A] rounded-[20px] flex items-center justify-center mx-auto mb-4">
