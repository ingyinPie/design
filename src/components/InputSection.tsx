  ...
  return (
    <div className="card-float p-8 mb-8 animate-fade-in">
      <div className="flex items-center gap-3 mb-6">
        <div className="w-12 h-12 bg-gradient-to-br from-[#196E7F] to-[#145963] rounded-[20px] flex items-center justify-center shadow-md">
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          {!imageUrl ? (
            <label className="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-[#196E7F] rounded-2xl cursor-pointer hover:border-[#145963] hover:bg-blue-50 transition-all duration-300">
              <div className="flex flex-col items-center justify-center pt-5 pb-6">
                <Upload className="w-10 h-10 text-[#196E7F] mb-3" />
            ...
            <div className="relative w-full h-40 rounded-2xl overflow-hidden border-2 border-[#196E7F]">
              <img
                src={imageUrl}
