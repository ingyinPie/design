    ...
    <div className="bg-[#C8D1D4] rounded-2xl shadow-md p-6">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 rounded-xl flex items-center justify-center border-2 border-[#5C9DFF]">
            <Bell className="w-6 h-6 text-[#5C9DFF]" />
          </div>
          <div>
        ...
        <button
          onClick={onAddAlarm}
          className="px-6 py-3 bg-[#5C9DFF] text-white rounded-xl font-semibold hover:bg-[#4A8BFF] transition-all flex items-center gap-2 shadow-md"
        >
